...
public class AbstractIT {
    ...
    static final String CLIENT_SECRET = "34ZPtSN5BZaTI2tZeYntOVX8yOfTT6nD";
    static final String USERNAME = "raj";
    static final String PASSWORD = "Raj@123";
    static String KEYCLOAK_IMAGE = "quay.io/keycloak/keycloak:26.3.0";
    static String WIREMOCK_IMAGE = "wiremock/wiremock:3.5.2-alpine";
    ...
    static WireMockContainer wiremockServer = new WireMockContainer(WIREMOCK_IMAGE);
